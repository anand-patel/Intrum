...
{
    /**
     * Copy the Diglin Intrum Library into the appropriate Magento lib folder
     *
    ...
    public static function postPackageAction(PackageEvent $event)
    {
        ...
        if (isset($extras['magento-root-dir'])) {
            ...
            if (is_dir($magentoPath . 'lib')) {
                if (is_dir($magentoPath . 'lib/Diglin/Intrum')) {
                    self::_recursiveRmDir($magentoPath . 'lib/Diglin/Intrum');
                }
                self::_recurseCopy(dirname(__DIR__), $magentoPath . 'lib/Diglin/Intrum');
            }
        }
    }

    /**
     * Remove the installed library Diglin Intrum from the lib Magento folder
     *
     * @param PackageEvent $event
     */
